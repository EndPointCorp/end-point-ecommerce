...
namespace EndPointEcommerce.Infrastructure.Data;

public class EndPointEcommerceDbContext : DbContext
{
    ...
    public EndPointEcommerceDbContext (DbContextOptions<EndPointEcommerceDbContext> options) : base(options) { }
