...
using EndPointEcommerce.WebStore;
...
builder.Services.AddHttpClient(
    "EndPointEcommerce.WebApi",
    opt => opt.BaseAddress = new Uri(
        builder.Configuration["EndPointEcommerceApiUrl"] ??
            throw new InvalidOperationException("Config setting 'EndPointEcommerceApiUrl' not found.")
    )
