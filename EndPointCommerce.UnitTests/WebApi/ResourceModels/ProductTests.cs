namespace EndPointCommerce.UnitTests.WebApi.ResourceModels;

public class ProductTests
{
    private EndPointCommerce.Domain.Entities.Product CreateProduct()
    {
        return new EndPointCommerce.Domain.Entities.Product
        {
            Id = 10,
            Name = "test_name",
    ...
    public void FromEntity_ReturnsANewInstance_WithTheCorrectFields()
    {
        ...
        entity.Category = new EndPointCommerce.Domain.Entities.Category {
            Id = 20,
    ...
    {
        // Arrange
        var entities = new List<EndPointCommerce.Domain.Entities.Product>
        {
            new()
            {
                Id = 10,
