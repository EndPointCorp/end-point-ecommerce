...
public class SearchControllerTests : IntegrationTests
{
    ...
    public async Task GetSearchProducts_ReturnsMatchingProducts_WhenSearchingByName()
    {
        ...
        var products = await response.Content.ReadFromJsonAsync<IEnumerable<EndPointEcommerce.WebApi.ResourceModels.Product>>();
    ...
    public async Task GetSearchSuggestionsProducts_ReturnsMatchingProducts_WhenSearchingByName()
    {
        ...
        var results = await response.Content.ReadFromJsonAsync<IEnumerable<EndPointEcommerce.Domain.Interfaces.IProductRepository.SearchSuggestion>>();
