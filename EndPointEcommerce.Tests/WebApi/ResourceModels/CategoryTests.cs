...
public class CategoryTests
{
    ...
    {
        // Arrange
        var entity = new EndPointEcommerce.Domain.Entities.Category
        {
            Id = 10,
            Name = "test_name",
            UrlKey = "test_url_key",
        ...
        var result = EndPointEcommerce.WebApi.ResourceModels.Category.FromEntity(entity, "test_image_url");
    ...
    {
        // Arrange
        var entities = new List<EndPointEcommerce.Domain.Entities.Category>
        {
            new()
            {
                Id = 10,
        ...
        var result = EndPointEcommerce.WebApi.ResourceModels.Category.FromListOfEntities(entities, "test_image_url");
