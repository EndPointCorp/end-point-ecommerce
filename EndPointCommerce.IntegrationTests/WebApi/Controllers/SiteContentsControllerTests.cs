...
public class SiteContentsControllerTests : IntegrationTestFixture
{
    ...
    private SiteContent CreateNewSiteContent(string name, string content)
    {
        ...
        _dbContext.SiteContents.Add(newSiteContent);
    ...
    public async Task GetSiteContents_ReturnsAllSiteContents_OrderedByName()
    {
        await WithTransaction(async () => {
            // Arrange
            _dbContext.Database.ExecuteSqlRaw("TRUNCATE TABLE site_contents");
