using EndPointCommerce.AdminPortal;
...
{
    public class IdentityServiceTests : IClassFixture<DatabaseFixture>, IClassFixture<WebApplicationFactory<Program>>
    {
        ...
        public IdentityServiceTests(DatabaseFixture database, WebApplicationFactory<Program> factory)
        {
            _database = database;
        ...
        public async Task Exists_ReturnsTrue_WhenTheUserExists()
        {
            ...
            {
                // Arrange
                _dbContext.Users.Add(new() { Id = 123 });
        ...
        public async Task AddAsync_CreatesANewUserOfTypeCustomer()
        {
            await _database.WithTransaction(_dbContext, async () =>
            {
                ...
                user = await _dbContext.Users.SingleOrDefaultAsync(u => u.UserName == "test_user_name");
        ...
        public async Task UpdateAsync_ChangesTheRole()
        {
            await _database.WithTransaction(_dbContext, async () =>
            {
                ...
                user = _dbContext.Users.Single(u => u.UserName == "test_user_name");
        ...
        public async Task UpdateAsync_ChangesTheUsername()
        {
            await _database.WithTransaction(_dbContext, async () =>
            {
                ...
                user = _dbContext.Users.SingleOrDefault(u => u.UserName == "another_test_user_name");
        ...
        public async Task DeleteAsync_DeletesTheUser_WhenItExists()
        {
            await _database.WithTransaction(_dbContext, async () =>
            {
                ...
                user = _dbContext.Users.FirstOrDefault(u => u.UserName == "test_user_name");
                Assert.Null(user);
            });
        }
